...
/**
 * Кастомный хук useToast используется для управления уведомлениями в приложении.
 * Он предоставляет функции для добавления, обновления и закрытия уведомлений,
 * а также для управления их состоянием.
 *
